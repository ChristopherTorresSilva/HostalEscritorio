 ...
 * @author Chriss
 */
public class registrarEmpresa extends javax.swing.JInternalFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtCorreo, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE)
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        int perfil = 2;
        //int perfil = parseInt(comboRubro.selectedValue)
        String rut = txtRut.getText();
        String nombre = txtNombre.getText();
        String correo = txtCorreo.getText();
        //int cargo = parseInt(comboRubro.selectedValue)
        main _main = new main();
        
        boolean _resp = _main.createEmpresa(userN, perfil, rut, nombre, correo);
        if(!_resp){
